...
class RoundThermostatCard extends HTMLElement {
  constructor() {
    super();
  ...
  setConfig(config) {
    ...
    if (!cardConfig.num_ticks) cardConfig.num_ticks = 100;
...
customElements.define('round-thermostat-card', RoundThermostatCard);
